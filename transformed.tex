...
\usepackage[margin=2cm, top=40mm]{geometry}
\usepackage{titlesec}
...
\AddToShipoutPictureBG{%
  \AtPageUpperLeft{%
    \put(0,0){\makebox(0,0)[lt]{\includegraphics[width=\paperwidth]{header.png}}}%
  }%
  \AtPageCenter{%
    \put(0,0){\makebox(0,0)[c]{\transparent{0.15}\includegraphics[width=0.8\paperwidth,keepaspectratio]{watermark.png}}}%
  }%
}
